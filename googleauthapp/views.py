...
from googleauthapp.forms import BookingForm
...
service_account_email = "booking-test-service-account@upheld-arena-355505.iam.gserviceaccount.com"
credentials = service_account.Credentials.from_service_account_file('upheld-arena-355505-eafa5172beec.json')
scoped_credentials = credentials.with_scopes(SCOPES)
calendarId = "2010238c4oqlnnm5qsek6rdsks@group.calendar.google.com"
